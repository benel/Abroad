...
feature 'Selected choice after the jury #6' do
	...
	background 'history of courses' do
		...
		click_on '*MGL800* - Gestion de projet en génie logiciel'
	end
	
	scenario 'enter a comment and validate' do
		
		visit 'http://abroad.utt.fr/university/256423/MGL800/'
		fill_in 'Commentaire', :with => 'UV très interessante pour appronfondir la gestion de projet logiciel'
		fill_in 'semestre_depart', :with => 'Automne 2013'
		
		# Choisir une note de 1 à 5 (1 étoile = note_1, 2 étoile = note_2,etc.)
		#
		
		click_on 'note_2'
		click_on 'retour_experience_MGL800'
		page.should have_content 'UV très interessante pour appronfondir la gestion de projet logiciel'
